...
// Source - https://stackoverflow.com/a/12386915
// Posted by Minh Nguyen, modified by community. See post 'Timeline' for change history
...
// Retrieved from: https://github.com/Michaelangel007/crc32#crc32-implementation
// Retrieved from Gemini This is the standard "Reflected" way to do what your code does

u32 crc32_standard(u32 crc, size_t len, const void *data) {
    const unsigned char *buffer = (const unsigned char*) data;

    while(len--) {
        // 0xEDB88320 is the reflected version of 0x04C11DB7
        // In this version, we shift RIGHT (LSB-first)
